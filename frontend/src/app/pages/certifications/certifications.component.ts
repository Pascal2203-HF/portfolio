...
@Component({
  ...
  template: `
    <section class="section">
      <div class="container">
        <p class="eyebrow mb-2">Reconnaissances</p>
        <h2 class="section-title">Certifications</h2>
        <div class="row g-4">
          <div class="col-md-4" *ngFor="let c of items; let i = index" appReveal [revealDelay]="i * 90">
            <div class="app-card h-100 p-3 text-center">
              ...
              <p class="opacity-50 small font-mono">{{ c.date_obtained }}</p>
